<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformanceAnalysis.aspx.cs" Inherits="PerformanceAnalysis" MasterPageFile="~/coreERP.Master" %>

<asp:Content ID="titleContent" ContentPlaceHolderID="titlePlaceHolder" runat="server">Loan Performance Analysis</asp:Content>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    ...
    <div class="wrapper">
        <div class="left">  
            <telerik:RadHtmlChart runat="server" ID="chComp" Width="650px"> 
                <Appearance>
        ...
        <div class="right"> 
            <telerik:RadHtmlChart runat="server" ID="chCol"  Width="650px">                
                <Appearance>
                        <FillStyle BackgroundColor="White"></FillStyle>
                </Appearance>
    ...
    <div class="wrapper">
        <div class="left">
            ...
            <telerik:RadGrid ID="gridTopBorrowers" runat="server" AutoGenerateColumns="false" Width="100%" PageSize="15" AllowPaging="true" 
        ...
        <div class="right">
            ...
            <telerik:RadGrid ID="gridDue" runat="server" AutoGenerateColumns="false" Width="100%" PageSize="15" AllowPaging="true" 
