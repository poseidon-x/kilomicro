<%@ Page Title="" Language="C#" MasterPageFile="~/gl/gl.master" AutoEventWireup="true" CodeBehind="tx_by_acc.aspx.cs" Inherits="coreERP.fa.reports.tx_by_acc" %>
...
<DateInput DisplayDateFormat="dd-MMM-yyyy" DateFormat="dd-MMM-yyyy"></DateInput>
            ...
            <tr>
                ...
                <td align="left">
                 <telerik:RadComboBox ID="cboClient" runat="server" Height="200px" Width=" 225px"
                    DropDownWidth=" 255px" EmptyMessage="Please select an asset" HighlightTemplatedItems="true"
                    MarkFirstMatch="true" AutoCompleteSeparator="" >
                </telerik:RadComboBox>
                </td>
                <td align="right" style="font-weight:bold">
                ...
                <td align="left">
                 <telerik:RadComboBox ID="cboLoanType" runat="server" Height="200px" Width=" 225px"
                    DropDownWidth=" 255px" EmptyMessage="Please select an asset category" HighlightTemplatedItems="true"
                    MarkFirstMatch="true" AutoCompleteSeparator="" >
                </telerik:RadComboBox>
                </td>
            </tr>
