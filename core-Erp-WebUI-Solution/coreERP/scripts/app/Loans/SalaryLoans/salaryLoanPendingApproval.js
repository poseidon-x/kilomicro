    ...
    SalaryLoanPendingApplicationsUi.prototype.renderGrid = function () {
        ...
        $("#setupGrid").kendoGrid({
            dataSource: {
                transport: {
                    read: {
                        url: salaryLoanApiUrl + "/GetForEdit",
                        type: "POST",
                        beforeSend: function(req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    ...
                    command: [
                      {
                          ...
                          click: function (e) {
                              ...
                              window.location = "/ln/SalaryLoans/Apply/" + data.salaryLoanId.toString();
                          },
                      },
                      {
                          name: "approve",
                          ...
                          click: function (e) {
                              ...
                              // get the data bound to the current table row
                              var data = this.dataItem(tr);
                              window.location = "/ln/SalaryLoans/Approve/" + data.salaryLoanId.toString();
                          },
                      },
                      {
                          name: "deny",
                          ...
                          click: function (e) {
                              ...
                              // get the data bound to the current table row
                              var data = this.dataItem(tr);
                              window.location = "/ln/SalaryLoans/Deny/" + data.salaryLoanId.toString();
                          },
                      }],
                    width: 180,
                },
            ...
            excel: {
                fileName: "salaryLoansPendingApproval.xlsx"
            },
            pdf: {
                paperKind: "A4",
                landscape: true,
                fileName: "salaryLoansPendingApproval.pdf"
            },
            filterable: true,
            sortable: {
                mode: "multiple",
