...
function loadForm() {
    ...
    $.ajax({
        ...
        errorDialog(xhr.responseJSON.ExceptionMessage, "Error Denying Salary Loan");
...
function saveToServer() {
    ...
    $.ajax({
        ...
        successDialog("Successfully denied salary loan application", "Success", function () {
