...
function renderLoanRepaymentGrid(request) {
    ...
    $('#loanRepayGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualLoanRepayments",
                    type: "POST",
                    dataType: "json",
        ...
        pageable: {
            pageSize: 500,
            pageSizes: [500, 1000, 1500, 2000, 3000, 5000],
            previousNext: true,
            buttonCount: 5,
        },
...
function renderClientServiceChargeGrid(request) {
    ...
    $('#serviceChargeGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualClientServiceCharges",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
...
function renderSuSuGrid(request) {
    ...
    $('#susuGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualSusuReport",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
...
function renderFeesGrid(request) {
    ...
    $('#feesGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualFeesReport",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
...
function renderDisbursementGrid(request) {
    ...
    $('#disbursementGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualDisbursementReport",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
        ...
        columns: [
...

            {
                ...
                groupFooterTemplate: "Amt Disbursed :  #= kendo.toString(sum, '0,000.00') #"
            },
...
function renderDepositAdditionalGrid(request) {
    ...
    $('#depositAdditionGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualDepositAdditionals",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
...
function renderDepositWithdrawalGrid(request) {
    ...
    $('#depositWithdrawGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualDepositWithdrawals",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
...
function renderSavingAdditionalGrid(request) {
    ...
    $('#savingAddGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualSavingAdditionals",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
        ...
        columns: [
            ...
            },
            {
                ...
                title: 'Saving Amount',
                format: '{0: #,###.#0}',
                footerTemplate: "Overall Total Savings: #= kendo.toString(sum, '0,000.00') #",
                groupFooterTemplate: "Savings Amt :  #= kendo.toString(sum, '0,000.00') #"
            },            
           {
               field: 'SavingBalance',
...
function renderSavingWithdrawalGrid(request) {
    ...
    $('#savingWithGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetIndividualSavingWithdrawals",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
...
function renderOutstandingAndSavingGrid(request) {
    ...
    $('#outstandingLoanGrid').kendoGrid({
        ...
        dataSource: {
            transport: {
                read: {
                    url: CashierReportApiUrl + "/GetSavingAndOutstandingLoans",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json",
                    data: request,
        ...
        pdf: {
            multiPage: true,
            fileName: "OutstandingLoansAndSavings_Report.pdf",
            allPages: true
        },
        excel: {
...
function renderArrearsGrid(endDate) {
    dismissLoadingDialog();
    let realDate = endDate.toLocaleDateString();
    ...
    $('#arrearsGrid').kendoGrid({
        ...
        columns: [
            ...
            },
			{
			    field: 'amountDisbursed',
			    width: 130,
			    title: 'Loan Amount', format: '{0: #,###.#0}', groupFooterTemplate: "Grp Count: #= count#"
			},
			{
			    field: 'Payable',
			    width: 130,
			    title: 'Payable', format: '{0: #,###.#0}'
			},
            {
                field: 'Paid',
                width: 130,
                title: 'Paid ', format: '{0: #,###.#0}'
            },
            {
                field: 'outstanding',
                width: 130,
            ...
            },
			{
			    field: 'LastDueDate ',
			    width: 130,
			    title: 'Last Due Date', format: '{0:dd-MMM-yyyy}',
        ...
        pageable: {
            pageSize: 500,
            pageSizes: [500, 750, 1000, 1500, 2000, 2500,5000],
            previousNext: true,
            buttonCount: 5,
        },
        dataBound: function (e) {
