...
var staffCategoryApiUrl = coreERPAPI_URL_Root + "/crud/StaffCategory";
var StaffCategoryApiUrl = coreERPAPI_URL_Root + "/crud/StaffCategory";
    ...
    depositTypeUI.prototype.renderGrid = function () {
        ...
        $("#setupGrid").kendoGrid({
            dataSource: {
                transport: {
                    read: {
                        url: StaffCategoryApiUrl + "/Get",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    },
                    create: {
                        url: StaffCategoryApiUrl + "/Post",
                        type: "POST",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    ...
                    destroy: {
                        url: StaffCategoryApiUrl + "/Delete",
                        type: "DELETE",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
