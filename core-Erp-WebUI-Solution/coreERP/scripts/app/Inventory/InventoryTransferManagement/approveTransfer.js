...
function prepareUi() {
        ...
        var bt = '<input type="button" class="btn btn-primary" id="approve" value="Approve Transfer" />';
        var msg = '<font color="red" face="verdana">Transfer Approved!</font>';
        if (inventoryTransfer.approved == false) {
        ...
        $('#approve').click(function (event) {
            if ($("#approvalComments").val() == "") {
                ...
                if (confirm('Are you sure you want Approve this Transfer?')) {
                    displayLoadingDialog();
                    saveTransfer();
                } else {
...
function populateUi() {
    ...
    if (inventoryTransfer.approved) {
        $('#approvalComments').data('kendoEditor').value(inventoryTransfer.approvalComments);
...
function retrieveValues() {
    inventoryTransfer.approvalComments = $('#approvalComments').data('kendoEditor').value();
...
function saveToServer() {
    ...
    $.ajax({
        url: inventoryTransferApiUrl + '/PostApproval',
        type: 'Post',
        contentType: 'application/json',
