...
var relationTypeApiUrl = coreERPAPI_URL_Root + "/crud/RelationType";
var RelationTypeApiUrl = coreERPAPI_URL_Root + "/crud/RelationType";
    ...
    depositTypeUI.prototype.renderGrid = function () {
        ...
        $("#setupGrid").kendoGrid({
            dataSource: {
                transport: {
                    read: {
                        url: RelationTypeApiUrl + "/Get",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    },
                    create: {
                        url: RelationTypeApiUrl + "/Post",
                        type: "POST",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
