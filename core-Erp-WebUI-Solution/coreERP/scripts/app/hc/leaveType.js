...
var leaveTypeApiUrl = coreERPAPI_URL_Root + "/crud/LeaveType";
var LeaveTypeApiUrl = coreERPAPI_URL_Root + "/crud/LeaveType";
    ...
    depositTypeUI.prototype.renderGrid = function () {
        ...
        $("#setupGrid").kendoGrid({
            dataSource: {
                transport: {
                    read: {
                        url: LeaveTypeApiUrl + "/Get",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    },
                    create: {
                        url: LeaveTypeApiUrl + "/Post",
                        type: "POST",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
