...
var qualificationSubjectApiUrl = coreERPAPI_URL_Root + "/crud/QualificationSubject";
var QualificationSubjectApiUrl = coreERPAPI_URL_Root + "/crud/QualificationSubject";
    ...
    depositTypeUI.prototype.renderGrid = function () {
        ...
        $("#setupGrid").kendoGrid({
            dataSource: {
                transport: {
                    read: {
                        url: QualificationSubjectApiUrl + "/Get",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    },
                    create: {
                        url: QualificationSubjectApiUrl + "/Post",
                        type: "POST",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    ...
                    update: {
                        url: QualificationSubjectApiUrl + "/Put",
                        type: "PUT",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                    ...
                    destroy: {
                        url: QualificationSubjectApiUrl + "/Delete",
                        type: "DELETE",
                        beforeSend: function (req) {
                            req.setRequestHeader('Authorization', "coreBearer " + authToken);
                        }
                ...
                schema: {
                    model: {
                        id: "qualificationSubjectID",
                        fields:
                           {
                               qualificatiQualificationSubjectIDonTypeID: {
                                   validation: {
                                       required: true,
                                   },
                                   defaultValue: 0,
                               },
                               qualificationSubjectName: {
                                   validation: {
                                       required: true,
                                   },
                               },
            ...
            columns: [
                {
                    field: "qualificationSubjectName",
