<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="manage.aspx.cs" Inherits="coreERP.admin.manage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
            ...
            <asp:Panel runat="server" ID="pnlEditRole" Visible="false">
                   <table>
                        ...
                        <tr>
                            <td>Role Name:</td>
                            <td>
                                <asp:TextBox runat="server" ID="txtRolename" MaxLength="30" Width="150" Enabled="true"></asp:TextBox> 
    ...
    <telerik:RadSplitBar ID="RadSplitBar2" runat="server" /> 
        <telerik:RadPane ID="RadPane2" runat="server" Width="320px" > 
        <h5>Users
         </h5> 
