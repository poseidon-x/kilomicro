<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="modulesSuper.aspx.cs" Inherits="coreERP.admin.modulesSuper" %>
    ...
    function onClientContextMenuItemClicking(sender, args) {
        ...
        switch (menuItem.get_value()) {
            ...
            case "Delete":
                ...
                + " will remove the module and all its"
                + " sub-modules."
            ...
            <asp:Panel runat="server" ID="pnlEdit" Visible="false">
                   <table>
                        ...
                        <tr>
                            <td>Module Name:</td>
                            <td>
                                <asp:TextBox runat="server" ID="txtModuleName" MaxLength="100" Width="200"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvUnitName" runat="server" ControlToValidate="txtModuleName"
                                     ErrorMessage="!" Font-Bold="true" ToolTip="You must kindly enter the module's name.">
                        ...
                        <tr>
                            <td>Module URL:</td>
                            <td>
                                <asp:TextBox runat="server" ID="txtURL" MaxLength="250" Width="200"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtURL"
                                     ErrorMessage="!" Font-Bold="true" ToolTip="You must kindly enter the module's URL.">
                                </asp:RequiredFieldValidator>                            
                            </td>                            
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Sort Value:</td>
                            <td>
                                <asp:TextBox runat="server" ID="txtSortValue" MaxLength="5" Width="50" Text="0"></asp:TextBox>
