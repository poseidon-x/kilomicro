...
{
    public partial class modulesSuper : System.Web.UI.Page
    {

        coreSecurityEntities ent;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (User.Identity.Name.ToLower().Trim()!="coreadmin")
            {
            ...
            try
            {
                ...
                if (txtModuleID.Text == "-1")
                {
                    ...
                    foreach (RepeaterItem it in this.rptRoles.Items)
                    {
                        ...
                        p.roles.role_name == lblRole.Text && p.perms.perm_code == "A");
