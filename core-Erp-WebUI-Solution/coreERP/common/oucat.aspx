<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="oucat.aspx.cs" Inherits="coreERP.common.oucat" %>
        ...
        switch (menuItem.get_value()) {
            ...
            case "Delete":
                var result = confirm("Deleting this category will delete all " +
                    " " + treeNode.get_text() + "(s) and their sub units.\nDo you still want to continue?");
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h5>Define Organizational Structure
         </h5> 
