...
{
    public partial class gloucat : corePage
    {
        public override string URL
        {
            get { return "~/common/gloucat.aspx"; }
        }
        ...
        private void RenderTree(RadTreeNode parentNode, gl_ou_cat category)
        { 
        ...
        protected void RadTreeView1_ContextMenuItemClick(object sender, RadTreeViewContextMenuEventArgs e)
        {
            ...
            { 
                case "New":
                    RadTreeNode newCat = new RadTreeNode("New Cost Center Category");
