<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="True" CodeBehind="cust.aspx.cs" Inherits="coreERP.ar.cust" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
    ...
    <MasterTableView autogeneratecolumns="False"  EditMode="InPlace"
            datakeynames="cust_type_id" datasourceid="EntityDataSource6" AllowAutomaticDeletes="True"
               CommandItemDisplay="Top" Width="100%" Caption = "Customer Types" PagerStyle-AlwaysVisible="true">
             <CommandItemSettings AddNewRecordText="Add A Customer Type" />
          
    <Columns>
        <telerik:GridBoundColumn DataField="cust_type_id" DataType="System.String" 
            DefaultInsertValue="" HeaderText="cust_type_id" 
            SortExpression="cust_type_id" UniqueName="cust_type_id" ItemStyle-Width="40px"
            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridTemplateColumn DataField="cust_type_name" DataType="System.String" 
            DefaultInsertValue="" HeaderText="Customer Type" 
            SortExpression="cust_type_name" UniqueName="cust_type_name" ItemStyle-Width="200px"
            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
            <ItemTemplate>
                <span><%# DataBinder.Eval(Container.DataItem, "cust_type_name")%></span>
            </ItemTemplate>
            <EditItemTemplate>
                <asp:TextBox ID="txtcust_type_name" runat="server" Text='<%# Bind("cust_type_name") %>'
        ...
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected customer type?\nNote that customers created using this type and their corresponding transactions\nwill also be deleted.">
    ...
    <MasterTableView autogeneratecolumns="False" EditMode="PopUp"
            datakeynames="cust_id" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True"
               CommandItemDisplay="Top" Width="960px">
             <CommandItemSettings AddNewRecordText="Add A Customer" />
     <CommandItemSettings AddNewRecordText="Add A New Customer" />
           
                         <DetailTables>
                            <telerik:GridTableView AutoGenerateColumns="false" EditMode="PopUp"
                            DataKeyNames="cust_addr_id" DataSourceID="EntityDataSource2" 
                            AllowAutomaticDeletes="true" Width="800px"
                            CommandItemDisplay="Top" AllowAutomaticUpdates="true">                                 
                                 <CommandItemSettings AddNewRecordText="Add A Customer Address" />
                                 <ParentTableRelation>
                                    <telerik:GridRelationFields DetailKeyField="cust_id" MasterKeyField="cust_id" />
                                 </ParentTableRelation>
                                 <Columns>
                                    <telerik:GridBoundColumn DataField="cust_addr_id" DataType="System.Int32" 
                                        DefaultInsertValue="" HeaderText="cust_addr_id" ReadOnly="True" 
                                        SortExpression="cust_addr_id" UniqueName="cust_addr_id" Visible="false">
                                    </telerik:GridBoundColumn> 
                                    <telerik:GridTemplateColumn DataField="addr_type" DataType="System.String" 
                                        DefaultInsertValue="" HeaderText="Address Type" 
                                        ...
                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <span><%# AddressTypeName((int)DataBinder.Eval(Container.DataItem, "cust_addr_id"))%></span>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn DataField="city_id" DataType="System.Int32" 
                                        ...
                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <span><%# CityName((int)DataBinder.Eval(Container.DataItem, "cust_addr_id"))%></span>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                ...
                                <EditFormSettings InsertCaption="Add new Customer Address" CaptionFormatString="Edit Customer Address: {0}" 
                            ...
                            <telerik:GridTableView AutoGenerateColumns="false" EditMode="PopUp"
                            DataKeyNames="cust_phon_id" DataSourceID="EntityDataSource3" 
                            AllowAutomaticDeletes="true" Width="450px"
                            CommandItemDisplay="Top" AllowAutomaticUpdates="true">                                 
                                 <CommandItemSettings AddNewRecordText="Add A Customer Telephone Number" />
                                 <ParentTableRelation>
                                    <telerik:GridRelationFields DetailKeyField="cust_id" MasterKeyField="cust_id" />
                                 </ParentTableRelation>
                                 <Columns>
                                    <telerik:GridBoundColumn DataField="cust_phon_id" DataType="System.Int32" 
                                        DefaultInsertValue="" HeaderText="cust_phon_id" ReadOnly="True" 
                                        SortExpression="cust_phon_id" UniqueName="cust_phon_id" Visible="false">
                                    </telerik:GridBoundColumn>  
                                    <telerik:GridTemplateColumn DataField="phon_type" DataType="System.String" 
                                        ...
                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <span><%# PhoneTypeName((int)DataBinder.Eval(Container.DataItem, "cust_phon_id"))%></span>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                ...
                                <EditFormSettings InsertCaption="Add new Customer Telephone Number" CaptionFormatString="Edit Customer Telephone Number: {0}" 
    ...
    <Columns>
        <telerik:GridBoundColumn DataField="cust_id" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="cust_id" ReadOnly="True" 
        ...
        <telerik:GridBoundColumn DataField="cust_name" DefaultInsertValue="" 
            HeaderText="Customer Name" SortExpression="cust_name" UniqueName="cust_name" ItemStyle-Width="200px">
        </telerik:GridBoundColumn>
        <telerik:GridTemplateColumn DataField="cust_type_id" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="Type" 
            SortExpression="cust_type_id" UniqueName="cust_type_id" ItemStyle-Width="60px"
            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
            <ItemTemplate>
                <span><%# CustomerTypeName((int)DataBinder.Eval(Container.DataItem, "cust_id")) %></span>
            </ItemTemplate>
        </telerik:GridTemplateColumn>
        <telerik:GridTemplateColumn DataField="currency_id" DataType="System.Int32" 
            ...
            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
            <ItemTemplate>
                <span><%# CurrencyName((int)DataBinder.Eval(Container.DataItem, "cust_id"))%></span>
            </ItemTemplate>
        </telerik:GridTemplateColumn>
        ...
        <telerik:GridTemplateColumn DataField="ar_acct_id" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="AR Account" 
            SortExpression="ar_acct_id" UniqueName="ar_acct_id" ItemStyle-Width="100px"
            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
            <ItemTemplate>
                <span><%# AccountName((int)DataBinder.Eval(Container.DataItem, "cust_id"),1)%></span>
            </ItemTemplate>
        </telerik:GridTemplateColumn>
        <telerik:GridTemplateColumn DataField="vat_acct_id" DataType="System.Int32" 
            ...
            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
            <ItemTemplate>
                <span><%# AccountName((int)DataBinder.Eval(Container.DataItem, "cust_id"),2)%></span>
            </ItemTemplate>
        </telerik:GridTemplateColumn>
        <telerik:GridBoundColumn DataField="creation_date" DataType="System.DateTime" 
            DefaultInsertValue="" HeaderText="creation_date" SortExpression="creation_date" 
        ...
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ButtonType="ImageButton" ImageUrl="~/images/delete.jpg" 
            ConfirmText="Are you sure you want to delete the selected customer?\n Note that any related transactions will also be deleted.">
          </telerik:GridButtonColumn>
    </Columns> 
    <EditFormSettings InsertCaption="Add new Customer" CaptionFormatString="Edit Customer: {0}" 
        CaptionDataField="cust_name" EditFormType="Template" PopUpSettings-Modal="true">
        <FormTemplate>
           <table style="width: 450px">
            <tbody>
             <tr>
              <td>
                <label id="Label1" runat="server">Customer Account #:</label>
              </td>
              <td>
               <asp:TextBox ID="TextBox1" runat="server"
                    Text='<%# Bind("acc_num") %>' Width="80px" MaxLength="20"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
                ToolTip="Kindly provide customer account number before saving"  ErrorMessage="!" ForeColor="Red"  Font-Bold="true">
                </asp:RequiredFieldValidator>
                </td>
             </tr>
             <tr>
              <td>
                <label id="Label2" runat="server">Customer Name:</label>
              </td>
              <td>
               <asp:TextBox ID="TextBox2" runat="server"
                    Text='<%# Bind("cust_name") %>' Width="230px" MaxLength="250"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2"
                ToolTip="Kindly provide customer name before saving"  ErrorMessage="!" ForeColor="Red"  Font-Bold="true">
                </asp:RequiredFieldValidator>
                </td>
             </tr>
             <tr>
              <td>
                <label id="lblCountryName" runat="server">Customer Type:</label>
              </td>
              <td>
                    <telerik:RadComboBox ID="cboType" runat="server" Height="200px" Width=" 230px"
                            DropDownWidth=" 230px" EmptyMessage="Select a customer type" HighlightTemplatedItems="true"
                ...
                ToolTip="Kindly provide customer type before saving"  ErrorMessage="!" ForeColor="Red"  Font-Bold="true">
                </asp:RequiredFieldValidator>
                </td>
             </tr>
             <tr>
            ...
            <tr>
                ...
                DropDownWidth="230px" EmptyMessage="Select the Customer's Currency" HighlightTemplatedItems="true"
                ...
                <ItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="cboCur"
                         ErrorMessage="!" Font-Bold="true" ToolTip="You must kindly select the Customer's Currency."></asp:RequiredFieldValidator></td> 
            </tr> 
             <tr>
              <td>
                <label id="Label5" runat="server">AR Account:</label>
              </td>
              <td>
             ...
             <tr>
              <td>
                <label id="Label7" runat="server">Credit Terms:</label>
              </td>
              <td>
               <asp:TextBox ID="TextBox4" runat="server"
                    Text='<%# Bind("credit_terms") %>' Width="230px" MaxLength="4000"
    ...
    <ef:EntityDataSource ID="EntityDataSource2" runat="server" 
        ConnectionString="name=core_dbEntities" DefaultContainerName="core_dbEntities" 
        EnableDelete="True" EnableInsert="True" EnableUpdate="True" 
        EntitySetName="cust_addr" Where="it.cust_id == @cust_id">
        <WhereParameters>
            <asp:SessionParameter Name="cust_id" Type="Int32" />
        </WhereParameters>
    </ef:EntityDataSource>
    <ef:EntityDataSource ID="EntityDataSource3" runat="server" 
        ConnectionString="name=core_dbEntities" DefaultContainerName="core_dbEntities" 
        EnableDelete="True" EnableInsert="True" EnableUpdate="True" 
        EntitySetName="cust_phons" Where="it.cust_id == @cust_id">
        <WhereParameters>
            <asp:SessionParameter Name="cust_id" Type="Int32" />
        </WhereParameters>
    </ef:EntityDataSource>
