...
{
    public partial class inv : corePage
    {
        public override string URL
        {
            get { return "~/ar/inv.aspx"; }
        }
        ...
        protected void cboCust_SelectedIndexChanged(object o, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            Session["cust_id"] = e.Value;
        }
        ...
        protected void PopulateCurrencies()
        {
            try
            {
                using (core_dbEntities ent = new core_dbEntities())
                {
                    cboCur.DataSource = ent.currencies;
                    cboCur.DataBind();
