<%@ Page Title="" Language="C#" MasterPageFile="~/gl/gl.master" AutoEventWireup="true" CodeBehind="post.aspx.cs" Inherits="coreERP.gl.journal.post" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <15>Post Temporary G/L Journal Entries
         </15> 
    <telerik:RadSplitter ID="RadSplitter1" runat="server" Height="500px" Width="1448px">
        ...
        <telerik:RadPane ID="contentPane" runat="server">
            <asp:Button ID="btnPreview" runat="server" Text="Preview Selected Batches" 
            ...
            <asp:Button ID="btnPost" runat="server" Text="Post Selected Batches" 
                Width="242px" Enabled="false" onclick="btnPost_Click" OnClientClick="showProcessing();" /> 
