<%@ Page Title="" Language="C#" MasterPageFile="~/gl/gl.master" AutoEventWireup="true" CodeBehind="bal_sht_ct.aspx.cs" Inherits="coreERP.gl.reports.fin_stmt2.bal_sht_ct" %>
...
Balance Sheet (Analytical)
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Balance Sheet (Analytical)</h3>
    <div class="subForm">
