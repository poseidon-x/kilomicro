...
{
    public partial class trial_bal_closed : corePage
    {
        ReportDocument rpt;
        ...
        {
            get { return "~/gl/reports/trial_bal_closed.aspx"; }
        }
        ...
        private void Bind(DateTime endDate, int period, bool noTx)
        {
            ...
            var res = rent.get_acc_bals(DateTime.Now.AddYears(-50), endDate, noTx, true, ccID).ToList<vw_acc_bals>();
            if (res.Count == 0)
            {
