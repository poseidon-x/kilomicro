<%@ Page Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="approve.aspx.cs" Inherits="coreERP.hc.leave.approve" EnableEventValidation="false"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    ...
    <div class="subForm">
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                <telerik:RadNumericTextBox WrapperCssClass="inputControl" Enabled="false" ID="txtLeaveDays" runat="server" CssClass="inputControl" NumberFormat-DecimalDigits="0"></telerik:RadNumericTextBox>
            ...
            <div class="subFormInput">
                <telerik:RadDatePicker Enabled="false" ID="dtAppDate" runat="server" CssClass="inputControl" DateInput-DateFormat="dd-MMM-yyyy"></telerik:RadDatePicker>
            ...
            <div class="subFormInput">
               <telerik:RadComboBox Enabled="false" id="cboLeaveType" CssClass="inputControl" runat="server"></telerik:RadComboBox>
            ...
            <div class="subFormInput">
                <telerik:RadDatePicker Enabled="false" ID="dtpLeaveStartsDate" CssClass="inputControl" runat="server" DateInput-DateFormat="dd-MMM-yyyy"></telerik:RadDatePicker>
    ...
    <div class="subForm">
        <telerik:RadButton ID="btnSave" Text="Approve Leave Application" runat="server" OnClick="btnSave_Click"></telerik:RadButton>
    </div>
</asp:Content>
