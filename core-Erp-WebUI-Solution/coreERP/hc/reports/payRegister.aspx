<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="payRegister.aspx.cs" Inherits="coreERP.hc.reports.payRegister" %>
    ...
    <div style="text-align:center">
        <table style="padding-left:100px">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cboCategory" runat="server"
                        DropDownWidth="355px" EmptyMessage="Select an employee category" HighlightTemplatedItems="true"
                    MarkFirstMatch="true" AutoCompleteSeparator="" DropDownAutoWidth="Enabled" Width="300px"></telerik:RadComboBox>
                </td>
            </tr>  
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cboGrade" runat="server"
                        DropDownWidth="355px" EmptyMessage="Select a grade/level" HighlightTemplatedItems="true"
                    MarkFirstMatch="true" AutoCompleteSeparator="" DropDownAutoWidth="Enabled" Width="300px"></telerik:RadComboBox>
                </td>
            </tr>    
            <tr>
