<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="default2.aspx.cs" Inherits="coreERP.hc.staff._default2" %>
                   ...
                   <MasterTableView>
                       <Columns>
                           <telerik:GridHyperLinkColumn DataTextField="staffNo"  HeaderText="Staff No."
                               DataNavigateUrlFields="staffID" DataNavigateUrlFormatString="/hc/staff/staff2.aspx?id={0}"></telerik:GridHyperLinkColumn>
