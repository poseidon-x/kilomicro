<%@ Page Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="loan.aspx.cs" Inherits="coreERP.hc.loans.loan" EnableEventValidation="false"  %>
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ReadOnly="true" 
                        ID="txtPrincBalance" runat="server" CssClass="inputControl"></telerik:RadNumericTextBox>
            </div>
            <div class="subFormLabel">
                Interest Balance
            </div>
            <div class="subFormInput">
                <telerik:RadNumericTextBox WrapperCssClass="inputControl" ReadOnly="true" 
                    ID="txtInterestBalance" runat="server" CssClass="inputControl"></telerik:RadNumericTextBox>
            </div>
            <div class="subFormLabel">
                Loan Type
            </div>
            <div class="subFormInput">
               <telerik:RadComboBox id="cboLoanType" runat="server" CssClass="inputControl"></telerik:RadComboBox>
            ...
            <div class="subFormInput">
               <telerik:RadDatePicker ID="dtpDeductionStartsDate" runat="server" CssClass="inputControl" DateInput-DateFormat="dd-MMM-yyyy"></telerik:RadDatePicker>
            ...
            <div class="subFormInput">
               <asp:CheckBox runat="server" ID="chkAttractsInterest" CssClass="inputControl"  />
            </div>
            <div class="subFormLabel">
               Interest Rate
            </div>
            <div class="subFormInput">
               <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtInterestRate" runat="server" CssClass="inputControl" Value="0"></telerik:RadNumericTextBox>
            </div>
        </div>
    </div>
    <br />
    <div class="subForm">
        <telerik:RadButton ID="btnSave" Text="Save Loan Application" runat="server" OnClick="btnSave_Click"></telerik:RadButton>
        <telerik:RadButton ID="btnSave2" Text="Save To Continue Later" runat="server" OnClick="btnSave2_Click"></telerik:RadButton> 
    </div>
    <br />  
