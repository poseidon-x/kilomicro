<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="staffLoanType.aspx.cs" Inherits="coreERP.hc.setup.staffLoanType" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Manage Staff Loan Types
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Types of Staff Loans</h3> 
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="loanTypeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px" allowSorting="true">
    <Columns>
        <telerik:GridBoundColumn DataField="loanTypeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="loanTypeID" ReadOnly="True" 
            SortExpression="loanTypeID" UniqueName="loanTypeID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="loanTypeName" DefaultInsertValue="" 
            HeaderText="Staff Loan Description" SortExpression="loanTypeName" UniqueName="loanTypeName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>
        <telerik:GridCheckBoxColumn DataField="attractsInterest" DefaultInsertValue="" 
            HeaderText="Attracts Interest?" SortExpression="attractsInterest" UniqueName="attractsInterest">
        ...
        <telerik:GridNumericColumn DataField="timeToRepay" DefaultInsertValue="" 
            HeaderText="Tenure (months)" SortExpression="timeToRepay" UniqueName="timeToRepay" DataFormatString="{0:#,###.#0}">
        </telerik:GridNumericColumn>  
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected Staff Loan Type?">
