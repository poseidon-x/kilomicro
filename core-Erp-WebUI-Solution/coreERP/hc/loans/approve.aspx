<%@ Page Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="approve.aspx.cs" Inherits="coreERP.hc.loans.approve" EnableEventValidation="false"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    ...
    <div class="subForm">
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                <telerik:RadDatePicker ID="dtAppDate" runat="server" DateInput-DateFormat="dd-MMM-yyyy" Enabled="false" CssClass="inputControl"></telerik:RadDatePicker>
            ...
            <div class="subFormInput">
                <telerik:RadComboBox id="cboLoanType" runat="server" Enabled="false" CssClass="inputControl"></telerik:RadComboBox>
            ...
            <div class="subFormInput">
                <telerik:RadDatePicker ID="dtpDeductionStartsDate" runat="server" DateInput-DateFormat="dd-MMM-yyyy" Enabled="false" CssClass="inputControl"></telerik:RadDatePicker>
            ...
            <div class="subFormInput">
               <asp:CheckBox runat="server" ID="chkAttractsInterest" Enabled="false" CssClass="inputControl" />
            </div>
            <div class="subFormLabel">
                Interest Rate
            </div>
    ...
    <br />
    <div class="subForm">
        <telerik:RadButton ID="btnSave" Text="Approve Loan Application" runat="server" OnClick="btnSave_Click"></telerik:RadButton> 
    </div>
    <br />  
