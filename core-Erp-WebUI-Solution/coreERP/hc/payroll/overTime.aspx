<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="overTime.aspx.cs" Inherits="coreERP.hc.payroll.overTime" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Staff Over Time for the Month </h3> 
    <div class="subForm">
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="overTimeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px" allowSorting="true">
    <Columns>
        <telerik:GridBoundColumn DataField="overTimeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="overTimeID" ReadOnly="True" 
            SortExpression="overTimeID" UniqueName="overTimeID" Visible="false">
        ...
        <telerik:GridNumericColumn DataField="saturdayHours" DefaultInsertValue="" 
            HeaderText="Saturday Hours" SortExpression="saturdayHours" UniqueName="saturdayHours" DataFormatString="{0:#,###.#0}">
        </telerik:GridNumericColumn>  
        <telerik:GridNumericColumn DataField="sundayHours" DefaultInsertValue="" 
            HeaderText="Sunday Hours" SortExpression="sundayHours" UniqueName="sundayHours" DataFormatString="{0:#,###.#0}">
        </telerik:GridNumericColumn> 
         <telerik:GridNumericColumn DataField="holidayHours" DefaultInsertValue="" 
            HeaderText="Holiday Hours" SortExpression="holidayHours" UniqueName="holidayHours" DataFormatString="{0:#,###.#0}">
        </telerik:GridNumericColumn>
        <telerik:GridNumericColumn DataField="weekdayAfterWorkHours" DefaultInsertValue="" 
            HeaderText="Week Day After WorkHours" SortExpression="weekdayAfterWorkHours" UniqueName="weekdayAfterWorkHours" DataFormatString="{0:#,###.#0}">
        </telerik:GridNumericColumn>
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected over time?">
