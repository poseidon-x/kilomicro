...
{
    public partial class staffDaysWorked : corePage
    {
        core_dbEntities ent;
        ...
        {
            get { return "~/hc/payroll/staffDaysWorked.aspx"; }
        }
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_staffDaysWorkeds";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Canceled = true;
                var staffDaysWorkedID = (int)e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["staffDaysWorkedID"];
                var b = le.staffDaysWorkeds.FirstOrDefault(p => p.staffDaysWorkedID == staffDaysWorkedID);
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true;
                coreLogic.staffDaysWorked b = new coreLogic.staffDaysWorked();
                b.payCalendarID = int.Parse(cboPayCalendar.SelectedValue);
                b.staffID = int.Parse(newVals["staffID"].ToString());
                b.daysWorked = float.Parse(newVals["daysWorked"].ToString()); 

                le.staffDaysWorkeds.Add(b);
                le.SaveChanges();
