<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="staffSavingsAccounts.aspx.cs" Inherits="coreERP.hc.payroll.staffSavingsAccounts" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Setup Employee Salary Accounts
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Setup Employee Salary Accounts</h3>  
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="staffSavingID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px" allowSorting="true">
    <Columns>
        <telerik:GridBoundColumn DataField="staffSavingID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="staffSavingID" ReadOnly="True" 
            SortExpression="staffSavingID" UniqueName="staffSavingID" Visible="false">
        ...
        <telerik:GridDropDownColumn DataField="savingID" DataSourceID="EntityDataSource3"
             ListValueField="savingID" ListTextField="savingNo" HeaderText="Savings Account"></telerik:GridDropDownColumn>   
