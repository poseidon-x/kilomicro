...
{
    public partial class performanceArea : corePage
    {
        core_dbEntities ent;
        coreLoansEntities le;
        public override string URL
        {
            get { return "~/hc/setup/performanceArea.aspx"; }
        }
        ...
        protected void RadGrid1_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == Telerik.Web.UI.RadGrid.InitInsertCommandName)
            {
                ...
                newVals["performanceAreaName"] = string.Empty;  
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_performanceAreas";
        ...
        protected void btnPDF_Click(object sender, System.EventArgs e)
        {
            ...
            RadGrid1.ExportSettings.OpenInNewWindow = true;
            this.RadGrid1.ExportSettings.FileName = "coreERP_performanceAreas";
            this.RadGrid1.ExportSettings.Pdf.Title = "Performance Areas Defined in System";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Canceled = true;
                var performanceAreaID = (int)e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["performanceAreaID"];
                var b = le.performanceAreas.FirstOrDefault(p => p.performanceAreaID == performanceAreaID);
                b.performanceAreaName = newVals["performanceAreaName"].ToString();
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true;
                coreLogic.performanceArea b = new coreLogic.performanceArea();
                b.performanceAreaName = newVals["performanceAreaName"].ToString();
                b.createdBy = User.Identity.Name;
                b.creationDate = DateTime.Now;
                le.performanceAreas.Add(b);
                le.SaveChanges();
