<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="taxTable.aspx.cs" Inherits="coreERP.hc.setup.taxTable" %>
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="taxTableID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px" allowSorting="true">
    <Columns>
        <telerik:GridBoundColumn DataField="taxTableID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="taxTableID" ReadOnly="True" 
            SortExpression="taxTableID" UniqueName="taxTableID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridNumericColumn DataField="sortOrder" DefaultInsertValue="" 
            HeaderText="Order 'N'" SortExpression="sortOrder" UniqueName="sortOrder">
        </telerik:GridNumericColumn> 
        <telerik:GridNumericColumn DataField="amount" DefaultInsertValue="" 
            HeaderText="Next 'N' Amount" SortExpression="amount" UniqueName="amount" DataFormatString="{0:#,###.#0}">
        </telerik:GridNumericColumn>   
        <telerik:GridNumericColumn DataField="taxPercent" DefaultInsertValue="" 
            HeaderText="Tax Percentage" SortExpression="taxPercent" UniqueName="taxPercent">
        </telerik:GridNumericColumn> 
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected Tax Table Entry?">
