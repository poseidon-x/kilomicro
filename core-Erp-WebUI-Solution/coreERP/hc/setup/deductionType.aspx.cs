...
{
    public partial class deductionType : corePage
    {
        core_dbEntities ent;
        coreLoansEntities le;
        public override string URL
        {
            get { return "~/hc/setup/deductionType.aspx"; }
        }
        ...
        protected void RadGrid1_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == Telerik.Web.UI.RadGrid.InitInsertCommandName)
            {
                ...
                newVals["deductionTypeName"] = string.Empty;
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_deductionTypes";
        ...
        protected void btnPDF_Click(object sender, System.EventArgs e)
        {
            ...
            RadGrid1.ExportSettings.OpenInNewWindow = true;
            this.RadGrid1.ExportSettings.FileName = "coreERP_deductionTypes";
            this.RadGrid1.ExportSettings.Pdf.Title = "Deduction Types Defined in System";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Canceled = true;
                var deductionTypeID = (int)e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["deductionTypeID"];
                var b = le.deductionTypes.FirstOrDefault(p => p.deductionTypeID == deductionTypeID);
                b.deductionTypeName = newVals["deductionTypeName"].ToString();
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true;
                coreLogic.deductionType b = new coreLogic.deductionType();
                b.deductionTypeName = newVals["deductionTypeName"].ToString();
                b.isPercent = bool.Parse(newVals["isPercent"].ToString());
                b.isBeforeTax = bool.Parse(newVals["isBeforeTax"].ToString());
                b.amount = double.Parse(newVals["amount"].ToString());
