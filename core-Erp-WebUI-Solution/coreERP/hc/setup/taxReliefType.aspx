<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="taxReliefType.aspx.cs" Inherits="coreERP.hc.setup.taxReliefType" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Manage TaxRelief Types
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Types of TaxReliefs</h3> 
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="taxReliefTypeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px" allowSorting="true">
    <Columns>
        <telerik:GridBoundColumn DataField="taxReliefTypeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="taxReliefTypeID" ReadOnly="True" 
            SortExpression="taxReliefTypeID" UniqueName="taxReliefTypeID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="taxReliefTypeName" DefaultInsertValue="" 
            HeaderText="TaxRelief Description" SortExpression="taxReliefTypeName" UniqueName="taxReliefTypeName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn> 
        ...
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected TaxRelief Type?">
