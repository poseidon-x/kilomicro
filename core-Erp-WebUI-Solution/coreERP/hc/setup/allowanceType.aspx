<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="allowanceType.aspx.cs" Inherits="coreERP.hc.setup.allowanceType" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Types of Allowances</h3> 
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn DataField="alllowanceTypeName" DefaultInsertValue="" 
            HeaderText="Allowance Description" SortExpression="alllowanceTypeName" UniqueName="alllowanceTypeName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>
        ...
        <telerik:GridCheckBoxColumn DataField="addToBasicAndTax" DefaultInsertValue="" 
            HeaderText="Tax with Basic?" SortExpression="addToBasicAndTax" UniqueName="addToBasicAndTax">
        </telerik:GridCheckBoxColumn> 
        ...
        <telerik:GridNumericColumn DataField="taxPercent" DefaultInsertValue="" 
            HeaderText="Tax Rate" SortExpression="taxPercent" UniqueName="taxPercent" DataFormatString="{0:#,###.#0}">
        </telerik:GridNumericColumn>      
