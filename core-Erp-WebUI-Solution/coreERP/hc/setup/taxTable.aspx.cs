...
{
    public partial class taxTable : corePage
    {
        core_dbEntities ent;
        coreLoansEntities le;
        public override string URL
        {
            get { return "~/hc/setup/taxTable.aspx"; }
        }
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_taxTables";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Canceled = true;
                var taxTableID = (int)e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["taxTableID"];
                var b = le.taxTables.FirstOrDefault(p => p.taxTableID == taxTableID);
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true;
                coreLogic.taxTable b = new coreLogic.taxTable();
                b.amount = double.Parse(newVals["amount"].ToString());
                b.taxPercent = double.Parse(newVals["taxPercent"].ToString());
                b.sortOrder = int.Parse(newVals["sortOrder"].ToString());  
