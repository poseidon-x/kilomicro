<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="benefitsInKind.aspx.cs" Inherits="coreERP.hc.setup.benefitsInKind" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Types of Benefits In Kind </h3> 
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="benefitsInKindID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px" allowSorting="true">
    <Columns>
        <telerik:GridBoundColumn DataField="benefitsInKindID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="benefitsInKindID" ReadOnly="True" 
            SortExpression="benefitsInKindID" UniqueName="benefitsInKindID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="benefitsInKindName" DefaultInsertValue="" 
            HeaderText="Benefit Description" SortExpression="benefitsInKindName" UniqueName="benefitsInKindName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>
