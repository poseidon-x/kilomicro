<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="oneTimeDeductionType.aspx.cs" Inherits="coreERP.hc.setup.oneTimeDeductionType" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Manage One Time Deduction Types
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Types of One Time Deductions</h3> 
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="oneTimeDeductionTypeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px" allowSorting="true">
    <Columns>
        <telerik:GridBoundColumn DataField="oneTimeDeductionTypeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="oneTimeDeductionTypeID" ReadOnly="True" 
            SortExpression="oneTimeDeductionTypeID" UniqueName="oneTimeDeductionTypeID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="oneTimeDeductionTypeName" DefaultInsertValue="" 
            HeaderText="Deduction Description" SortExpression="oneTimeDeductionTypeName" UniqueName="oneTimeDeductionTypeName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>
        ...
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected One Time Deduction Type?">
    ...
    <ef:EntityDataSource ID="EntityDataSource1" runat="server" 
        ...
        EntitySetName="oneTimeDeductionTypes">
    </ef:EntityDataSource>
    </asp:Content>
