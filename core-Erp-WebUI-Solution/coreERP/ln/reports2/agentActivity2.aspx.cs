...
{
    public partial class agentActivity2 : corePage
    {
        ReportDocument rpt;
        public override string URL
        {
            get { return "~/ln/reports2/agentActivity2.aspx"; }
        }
        ...
        private void Bind(DateTime startDate, DateTime endDate)
        {
            ...
            rpt.SetParameterValue("title", "Payroll Agent Activity Report as at " + endDate.ToString("dd-MMM-yyyy"));
