<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="dtemplate.aspx.cs" Inherits="coreERP.ln.reports2.dtemplate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Client Deposit Statement</h3>
    <div class="subForm">
        <div class="subFormColumnLeft">
            ...
            <div class="subFormInput">
                <telerik:RadComboBox ID="cboDeposit" runat="server"
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                <telerik:RadComboBox ID="cboTemplate" runat="server"
                    DropDownWidth="355px" EmptyMessage="Select an Agreement Template" HighlightTemplatedItems="true"
                    MarkFirstMatch="true" AutoCompleteSeparator="" CssClass="inputControl">
                </telerik:RadComboBox>
            </div>
