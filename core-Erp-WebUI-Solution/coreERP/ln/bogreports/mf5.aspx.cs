...
{
    public partial class mf5 : corePage
    {
        ...
        {
            ReportDocument rpt = new coreReports.ln.bog.rptMF5(); 
            var res = (new reportEntities()).getMF5(endDate).ToList();
            ...
            rpt.SetParameterValue("reportTitle", "REPORT ON LOANS EXCEEDING 1% of PAID UP CAPITAL");
