<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="approveWriteOff.aspx.cs" Inherits="coreERP.ln.saving.approveWriteOff" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Write Off Interest on Savings Account
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Write-Off Interest on Savings Account</h3>
    <table>
        <tr>
            <td>Select Client</td>
            <td>
