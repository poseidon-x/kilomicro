<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="coreERP.ln.saving._default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Manage Regular Deposit Accounts
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Manage Regular Deposit Accounts</h3>
   <table>
       <tr>
           <td rowspan="20">
                   ...
                   <MasterTableView DataKeyNames="clientID">
                       ...
                       <DetailTables>
                           <telerik:GridTableView  ShowFooter="true" DataKeyNames="client.clientID">  
                                <Columns>                             
                                   <telerik:GridHyperLinkColumn DataTextField="savingNo"  HeaderText="Savings No."
                                       DataNavigateUrlFields="savingID" DataNavigateUrlFormatString="/ln/saving/saving.aspx?id={0}"></telerik:GridHyperLinkColumn>
