<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="coreERP.ln.agent._default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
   ...
   <table>
       <tr>
           ...
           <td style="height:30px">Agent Code</td>
           ...
           <td style="height:30px"><telerik:RadButton ID="btnFind" runat="server" Text="Find Agent" OnClick="btnFind_Click"></telerik:RadButton></td>
       </tr>
       <tr>
           <td colspan="7">
               <telerik:RadGrid ID="grid" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                   ...
                   <MasterTableView>
                       <Columns>
                           <telerik:GridHyperLinkColumn DataTextField="agentNo"  HeaderText="Agent Code" SortExpression="agentID"
                               DataNavigateUrlFields="agentID" DataNavigateUrlFormatString="/ln/agent/agent.aspx?id={0}"></telerik:GridHyperLinkColumn>
