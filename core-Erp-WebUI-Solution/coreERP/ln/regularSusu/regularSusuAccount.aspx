<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="regularSusuAccount.aspx.cs" Inherits="coreERP.ln.susu.regularSusuAccount" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Manage Normal Susu Accounts
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
    <h3>Manage Normal Susu Accounts</h3>   
        <div class="subForm">
            ...
            <div class="subFormColumnMiddle">       
                ...
                <div class="subFormInput">
                    <telerik:RadDatePicker ID="dtAppDate" runat="server" DateInput-DateFormat="dd-MMM-yyyy" CssClass="inputControl"
                ...
                <div class="subFormLabel">
                    Contribution Rate</div>
                <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtcontriRate" runat="server" CssClass="inputControl" Enabled="true" NumberFormat-DecimalDigits="2"
                      OnTextChanged="txtcontriRate_TextChanged">
                    </telerik:RadNumericTextBox>
                    <asp:RequiredFieldValidator ID="rfvcr" runat="server" ControlToValidate="txtcontriRate" ErrorMessage="!"
                         ForeColor="Red" Font-Bold="true" ToolTip="Please enter your contribution rate"></asp:RequiredFieldValidator>
                </div> 
            </div>
        ...
        <div class="subForm">
            <telerik:RadButton ID="btnSave" Text="Save Susu Account Application" runat="server" OnClick="btnSave_Click"
                ToolTip="Click to save the Normal Susu account application and exit this screen"></telerik:RadButton> 
        </div>
</asp:Content>
