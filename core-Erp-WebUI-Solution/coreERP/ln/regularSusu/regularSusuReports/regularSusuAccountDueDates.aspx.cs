...
{
    public partial class regularSusuAccountDueDates : corePage
    {
        ReportDocument rpt;
        public override string URL
        {
            get { return "~/ln/regularSusu/regularSusuReports/regularSusuAccountDueDates.aspx"; }
        }
        ...
        private void Bind(int? clientID)
        {
            ...
            rpt = new coreReports.rs.rptRegularSusuAccountsDuePerMonth();
