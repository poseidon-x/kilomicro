<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="regularSusuApprove.aspx.cs" Inherits="coreERP.ln.susu.regularSusuApprove" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Approve Normal Susu Accounts
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
    <h3>Approve Normal Susu Accounts</h3>   
        <div class="subForm">
        ...
        <div class="subForm">
            <telerik:RadButton ID="btnSave" Text="Approve Normal Susu Account Application" runat="server" OnClick="btnSave_Click"
