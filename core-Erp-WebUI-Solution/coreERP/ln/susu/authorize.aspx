<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="authorize.aspx.cs" Inherits="coreERP.ln.susu.authorize" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Authorize Susu Account for Payout
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">    
    <h3>Authorize Susu Account for Payout</h3>
        <div class="subForm">
            ...
            <div class="subFormColumnMiddle">       
                ...
                <div class="subFormInput">
                    <telerik:RadComboBox runat="server" ID="cboSusuGrade" CssClass="inputControl" AutoPostBack="true" CausesValidation="false" Enabled="false"
                ...
                <div class="subFormInput">
                    <telerik:RadComboBox runat="server" ID="cboSusuPosition" CssClass="inputControl" AutoPostBack="true" CausesValidation="false" Enabled="false"
               ...
               <div class="subFormInput">
                    <telerik:RadComboBox ID="cboStaff" runat="server" CssClass="inputControl" Enabled="false" 
                ...
                <div class="subFormInput">
                    <telerik:RadComboBox ID="cboAgent" runat="server" CssClass="inputControl" Enabled="false"
                ...
                <div class="subFormInput">
                    <telerik:RadComboBox runat="server" ID="cboSusuGroup" CssClass="inputControl" CausesValidation="false" Enabled="false"></telerik:RadComboBox>
