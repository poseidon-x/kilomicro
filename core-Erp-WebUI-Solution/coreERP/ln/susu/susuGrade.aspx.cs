...
{
    public partial class susuGrade : corePage
    {
        core_dbEntities ent;
        coreLoansEntities le;
        public override string URL
        {
            get { return "~/ln/setup/susuGrade.aspx"; }
        }
        ...
        protected void RadGrid1_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == Telerik.Web.UI.RadGrid.InitInsertCommandName)
            {
                ...
                newVals["susuGradeNo"] = 0;
                newVals["contributionAmount"] = 0;
                newVals["susuGradeName"] = "";
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_susuGrades";
        ...
        protected void btnPDF_Click(object sender, System.EventArgs e)
        {
            ...
            RadGrid1.ExportSettings.OpenInNewWindow = true;
            this.RadGrid1.ExportSettings.FileName = "coreERP_susuGrades";
            this.RadGrid1.ExportSettings.Pdf.Title = "susuGrades Defined in System";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Canceled = true; 
                var susuGradeID = (int)e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["susuGradeID"];
                var b = le.susuGrades.FirstOrDefault(p => p.susuGradeID == susuGradeID);

                b.susuGradeNo = int.Parse(newVals["susuGradeNo"].ToString());
                b.contributionAmount = double.Parse(newVals["contributionAmount"].ToString());
                b.susuGradeName = newVals["susuGradeName"].ToString(); 
                le.SaveChanges();
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true; 
                coreLogic.susuGrade b = new coreLogic.susuGrade();
