<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="susuAccountStatusUndisbursed.aspx.cs" Inherits="coreERP.ln.susu.analysis.susuAccountStatusUndisbursed" %>
    ...
    <telerik:RadGrid runat="server" ID="grid" AllowAutomaticDeletes="false" AllowAutomaticInserts="false" AllowAutomaticUpdates="false"
        ...
        <MasterTableView DataKeyNames="susuAccountID" ShowFooter="true" CommandItemDisplay="TopAndBottom">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="susuGradeNo" HeaderText="Grade" ItemStyle-Width="70px" SortExpression="susuGradeNo"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="susuPositionNo" HeaderText="Position" ItemStyle-Width="70px" SortExpression="susuPositionNo"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="susuGroupNo" HeaderText="Group" ItemStyle-Width="70px" SortExpression="susuGroupNo"></telerik:GridBoundColumn>
