<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="susuAccountStatus.aspx.cs" Inherits="coreERP.ln.susu.analysis.susuAccountStatus" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    ...
    <div class="subForm">
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                <telerik:RadComboBox runat="server" CssClass="inputControl" ID="cboStage" Width="300px">
                    <Items>
