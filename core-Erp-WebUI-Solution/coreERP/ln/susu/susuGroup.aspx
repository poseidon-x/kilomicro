<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="susuGroup.aspx.cs" Inherits="coreERP.ln.setup.susuGroup" %>
...
<MasterTableView autogeneratecolumns="False" EditMode="PopUp"
            datakeynames="susuGroupID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="760px">
    <Columns>
        <telerik:GridBoundColumn DataField="susuGroupID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="susuGroupID" ReadOnly="True" 
            SortExpression="susuGroupID" UniqueName="susuGroupID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="susuGroupNo" DefaultInsertValue="" 
            HeaderText="Group Number" SortExpression="susuGroupNo" UniqueName="susuGroupNo" ItemStyle-Width="150px">
        </telerik:GridBoundColumn>  
        <telerik:GridBoundColumn DataField="susuGroupName" DefaultInsertValue="" 
            HeaderText="Group Name (Description)" SortExpression="susuGroupName" UniqueName="susuGroupName" ItemStyle-Width="300px">
        </telerik:GridBoundColumn>  
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected Susu Group?">
