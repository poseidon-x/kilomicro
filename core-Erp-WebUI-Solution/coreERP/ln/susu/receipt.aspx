<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="receipt.aspx.cs" Inherits="coreERP.ln.susu.receipt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Susu Account Receipts
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Susu Account Receipts</h3>
    <div class="subForm">
    ...
    <div class="subForm">
        ...
        <div class="subFormColumnMiddle">       
            ...
            <div class="subFormInput">
                <telerik:RadComboBox ID="cboAccount" runat="server" AutoPostBack="true" 
                    ...
                    MarkFirstMatch="true" AutoCompleteSeparator="" CausesValidation="false" 
                    ToolTip="Select the  susu account for which payment is being entered"></telerik:RadComboBox>
            </div>  
            <div class="subFormLabel">
                Received Amount
            </div>
        ...
        <div class="subFormColumnRight">
            <div class="subFormLabel">
                ...
                <div class="subFormInput">
                    <telerik:RadDatePicker runat="server" CssClass="inputControl" ID="dtStarted" 
                        DateInput-DateFormat="dd-MMM-yyyy" Enabled="false"></telerik:RadDatePicker>
                </div> 
                <div class="subFormLabel">
                     Date Due
                </div> 
                ...
                <div class="subFormInput">
                    <telerik:RadDatePicker runat="server" ID="dtDisbursed" DateInput-DateFormat="dd-MMM-yyyy" Enabled="false"></telerik:RadDatePicker>
                </div>
        </div>
    </div>
    <div class="subForm">
        <div class="subFormColumnLeft">
            <telerik:RadButton ID="btnReceive" Text="Receive Susu Contribution" runat="server" OnClick="btnReceive_Click"
