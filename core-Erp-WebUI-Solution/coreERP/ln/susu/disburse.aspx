<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="disburse.aspx.cs" Inherits="coreERP.ln.susu.disburse" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Disburse Susu Accounts
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">    
    <h3>Disburse Susu Accounts</h3>
        <div class="subForm">
            ...
            <div class="subFormColumnMiddle">       
                ...
                <div class="subFormInput">
                    <telerik:RadComboBox runat="server" ID="cboSusuGrade" CssClass="inputControl" AutoPostBack="true" CausesValidation="false"
                         OnSelectedIndexChanged="cboSusuGrade_SelectedIndexChanged" Enabled="false"></telerik:RadComboBox>
                ...
                <div class="subFormInput">
                    <telerik:RadComboBox runat="server" ID="cboSusuPosition" CssClass="inputControl" AutoPostBack="true" CausesValidation="false"
                         OnSelectedIndexChanged="cboSusuPosition_SelectedIndexChanged" Enabled="false"></telerik:RadComboBox>
               ...
               <div class="subFormInput">
                ...
                <div class="subFormInput">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="dtDisbursed" ErrorMessage="!"
                         ForeColor="Red" Font-Bold="true" ToolTip="Please enter the disbursement date for the susu account"></asp:RequiredFieldValidator>
                </div>    
            </div>
