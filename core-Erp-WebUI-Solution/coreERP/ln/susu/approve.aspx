<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="approve.aspx.cs" Inherits="coreERP.ln.susu.approve" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Approve Susu Accounts
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">  
    <h3>Approve Susu Accounts</h3>  
        <div class="subForm">
        ...
        <div class="subForm">
            <telerik:RadButton ID="btnSave" Text="Approve Susu Account Application" runat="server" OnClick="btnSave_Click"
