<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="susuAccount.aspx.cs" Inherits="coreERP.ln.susu.susuAccount" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Manage Susu Accounts
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
    <h3>Manage Susu Accounts</h3>   
        <div class="subForm">
        ...
        <div class="subForm">
            <telerik:RadButton ID="btnSave" Text="Save Susu Account Application" runat="server" OnClick="btnSave_Click"
                ToolTip="Click to save the susu account application and exit this screen"></telerik:RadButton> 
        </div>
</asp:Content>
