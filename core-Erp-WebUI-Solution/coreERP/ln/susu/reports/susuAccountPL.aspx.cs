...
{
    public partial class susuAccountPL : corePage
    {
        ReportDocument rpt;
        public override string URL
        {
            get { return "~/ln/susu/reports/susuAccountPL.aspx"; }
        }
        ...
        private void Bind(int? clientID)
        {
            ...
            rpt = new coreReports.ss.rptCashflow();
            var rent = (new reportEntities());
            rent.Database.CommandTimeout = 10000;
            var res = rent.getSusuCashFlow(dtEndDate.SelectedDate)
                ...
                .OrderBy(p => p.entitledDate).ThenBy(p => p.clientName)
