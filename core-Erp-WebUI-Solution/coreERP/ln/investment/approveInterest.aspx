<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="approveInterest.aspx.cs" Inherits="coreERP.ln.investment.approveInterest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Approve Interest on Company Investment Account
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Approve Interest on Company Investment Account</h3>
    <table>
        <tr>
            <td>
        ...
        <ItemTemplate>
            <table width="950px">
                <tr>
                    ...
                    <td style="width:200px">
                        <asp:Label ID="lblClientName" runat="server" Text='<%#  GetClientName(DataBinder.Eval(Container.DataItem, "investmentScheduleID")) %>'></asp:Label>                        
                    <td style="width:100px">
