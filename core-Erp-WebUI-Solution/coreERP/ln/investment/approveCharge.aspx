<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="approveCharge.aspx.cs" Inherits="coreERP.ln.investment.approveCharge" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Approve Charges on Company Investment Account
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Approve Charges on Company Investment Account</h3>
    <table>
        <tr>
            <td>Select Client</td>
            <td>
        ...
        <tr>
            <td>Select Investment Account</td>
            <td>
        ...
        <tr>
            <a href="approveCharge.aspx">approveCharge.aspx</a>
