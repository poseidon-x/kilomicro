<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="withReceipt.aspx.cs" Inherits="coreERP.ln.investmentReports.withReceipt" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.3500.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
::Company Investment Withdrawal Receipt
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Company Investment Withdrawal Receipt</h3>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cboLoan" runat="server"
                        DropDownWidth="355px" EmptyMessage="Select a Investment" HighlightTemplatedItems="true"
