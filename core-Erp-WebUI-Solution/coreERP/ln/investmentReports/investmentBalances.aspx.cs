...
{
    public partial class investmentBalances : corePage
    {
        ReportDocument rpt;
                coreLoansEntities le = new coreLoansEntities();
        public override string URL
        {
            get { return "~/ln/investmentReports/investmentBalances.aspx"; }
        }
        ...
        {
            if (ViewState["filter"].ToString() == "2")
            {
                rpt = new coreReports.iv.rptInvestmentBalance2();
            }
            else
            {
                rpt = new coreReports.iv.rptInvestmentBalance();
            }
