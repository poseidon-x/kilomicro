...
{
    public partial class modeOfEntry : corePage
    {
        core_dbEntities ent;
        coreLoansEntities le;
        public override string URL
        {
            get { return "~/ln/setup/modeOfEntry.aspx"; }
        }
        ...
        protected void RadGrid1_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == Telerik.Web.UI.RadGrid.InitInsertCommandName)
            {
                ...
                newVals["modeOfEntryName"] = string.Empty; 
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_modeOfEntries";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Canceled = true; 
                var modeOfEntryID = (int)e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["modeOfEntryID"];
                var b = le.modeOfEntries.FirstOrDefault(p=> p.modeOfEntryID==modeOfEntryID);
                b.modeOfEntryName = newVals["modeOfEntryName"].ToString(); 
                le.SaveChanges();
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true; 
                coreLogic.modeOfEntry b = new coreLogic.modeOfEntry();
                b.modeOfEntryName = newVals["modeOfEntryName"].ToString(); 
                
                le.modeOfEntries.Add(b);
                le.SaveChanges();
