<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="openTill2.aspx.cs" Inherits="coreERP.ln.setup.openCloseTill2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    ...
    <table>
        ...
        <tr>
            <td>End Date:</td>
            <td><telerik:RadDatePicker ID="dtpEndDate" runat="server" DateInput-DateFormat="dd-MMM-yyyy"></telerik:RadDatePicker></td>
        </tr> 
        <tr>
            <td>Cashier:</td>
