<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="employeeContractType.aspx.cs" Inherits="coreERP.ln.setup.employeeContractType" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Manage Employee Contract Types
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Employee Contract Types</h3> 
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="employeeContractTypeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px">
    <Columns>
        <telerik:GridBoundColumn DataField="employeeContractTypeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="employeeContractTypeID" ReadOnly="True" 
            SortExpression="employeeContractTypeID" UniqueName="employeeContractTypeID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="employeeContractTypeName" DefaultInsertValue="" 
            HeaderText="Description" SortExpression="employeeContractTypeName" UniqueName="employeeContractTypeName" ItemStyle-Width="420px">
        </telerik:GridBoundColumn>  
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected employeeContractType?">
    ...
    <ef:EntityDataSource ID="EntityDataSource1" runat="server" 
        ...
        EntitySetName="employeeContractTypes">
    </ef:EntityDataSource>
    </asp:Content>
