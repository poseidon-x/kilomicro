<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="checkType.aspx.cs" Inherits="coreERP.ln.setup.checkType" %>
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="checkTypeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px">
    <Columns>
        <telerik:GridBoundColumn DataField="checkTypeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="checkTypeID" ReadOnly="True" 
            SortExpression="checkTypeID" UniqueName="checkTypeID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="checkTypeName" DefaultInsertValue="" 
            HeaderText="Check Type Name" SortExpression="checkTypeName" UniqueName="checkTypeName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>  
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected checkType?">
