<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="institution.aspx.cs" Inherits="coreERP.ln.setup.institution" %>
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="institutionID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px">
    <Columns>
        <telerik:GridBoundColumn DataField="institutionID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="institutionID" ReadOnly="True" 
            SortExpression="institutionID" UniqueName="institutionID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="institutionName" DefaultInsertValue="" 
            HeaderText="institution Name" SortExpression="institutionName" UniqueName="institutionName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>  
