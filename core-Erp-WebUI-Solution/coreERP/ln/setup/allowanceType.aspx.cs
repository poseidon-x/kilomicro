...
{
    public partial class prAllowanceType : corePage
    {
        core_dbEntities ent;
        ...
        protected void RadGrid1_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == Telerik.Web.UI.RadGrid.InitInsertCommandName)
            {
                ...
                newVals["allowanceTypeName"] = string.Empty;
                newVals["isPermanent"] = false; 
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_prAllowanceTypes";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                var b = le.prAllowanceTypes.FirstOrDefault(p=> p.allowanceTypeID==allowanceTypeID);
                b.allowanceTypeName = newVals["allowanceTypeName"].ToString();
                b.isPermanent = bool.Parse(newVals["isPermanent"].ToString());
                le.SaveChanges();
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true; 
                coreLogic.prAllowanceType b = new coreLogic.prAllowanceType();
                b.allowanceTypeName = newVals["allowanceTypeName"].ToString();
                b.isPermanent = bool.Parse(newVals["isPermanent"].ToString());
                
                le.prAllowanceTypes.Add(b);
                le.SaveChanges();
