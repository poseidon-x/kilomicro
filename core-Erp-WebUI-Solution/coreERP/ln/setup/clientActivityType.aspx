<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="clientActivityType.aspx.cs" Inherits="coreERP.ln.setup.clientActivityType" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Manage Client Activity Types
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Client Activity Types</h3> 
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="16px" >
     <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="EntityDataSource1"
        ...
        OnUpdateCommand="RadGrid1_UpdateCommand" Width="447px">
            <PagerStyle Mode="NextPrevAndNumeric" BorderStyle="None" />
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="clientActivityTypeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="560px">
    <Columns>
        <telerik:GridBoundColumn DataField="clientActivityTypeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="clientActivityTypeID" ReadOnly="True" 
            SortExpression="clientActivityTypeID" UniqueName="clientActivityTypeID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="clientActivityTypeName" DefaultInsertValue="" 
            HeaderText="Client Activity Name" SortExpression="clientActivityTypeName" UniqueName="clientActivityTypeName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>  
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected client Activity Type?">
    ...
    <ef:EntityDataSource ID="EntityDataSource1" runat="server" 
        ...
        EntitySetName="clientActivityTypes">
    </ef:EntityDataSource>
    </asp:Content>
