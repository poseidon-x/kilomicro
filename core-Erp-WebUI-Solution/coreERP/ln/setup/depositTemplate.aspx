<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="depositTemplate.aspx.cs" Inherits="coreERP.ln.setup.depositTemplate" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Manage Investment/Deposit Templates
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server"> 
        <h3>Manage Investment/Deposit Templates</h3> 
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="depositTemplateID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="1120px">
    <Columns>
        <telerik:GridBoundColumn DataField="depositTemplateID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="depositTemplateID" ReadOnly="True" 
            SortExpression="depositTemplateID" UniqueName="depositTemplateID" Visible="false">
    ...
    <ef:EntityDataSource ID="EntityDataSource1" runat="server" 
        ...
        EntitySetName="depositTemplates">
    </ef:EntityDataSource>
    </asp:Content>
