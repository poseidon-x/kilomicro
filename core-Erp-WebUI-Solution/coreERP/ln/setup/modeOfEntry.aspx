<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="modeOfEntry.aspx.cs" Inherits="coreERP.ln.setup.modeOfEntry" %>

<%@ Register Assembly="Microsoft.AspNet.EntityDataSource" 
    Namespace="Microsoft.AspNet.EntityDataSource" TagPrefix="ef" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
Manage Mode Of Entries
</asp:Content>
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="modeOfEntryID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px">
    <Columns>
        <telerik:GridBoundColumn DataField="modeOfEntryID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="modeOfEntryID" ReadOnly="True" 
            SortExpression="modeOfEntryID" UniqueName="modeOfEntryID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="modeOfEntryName" DefaultInsertValue="" 
            HeaderText="Mode of Entry" SortExpression="modeOfEntryName" UniqueName="modeOfEntryName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>   
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected modeOfEntry?">
