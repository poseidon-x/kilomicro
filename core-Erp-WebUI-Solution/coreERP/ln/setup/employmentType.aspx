<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="employmentType.aspx.cs" Inherits="coreERP.ln.setup.employmentType" %>
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="employmentTypeID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px">
    <Columns>
        <telerik:GridBoundColumn DataField="employmentTypeID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="employmentTypeID" ReadOnly="True" 
            SortExpression="employmentTypeID" UniqueName="employmentTypeID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="employmentTypeName" DefaultInsertValue="" 
            HeaderText="Description" SortExpression="employmentTypeName" UniqueName="employmentTypeName" ItemStyle-Width="420px">
        </telerik:GridBoundColumn>  
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected employmentType?">
