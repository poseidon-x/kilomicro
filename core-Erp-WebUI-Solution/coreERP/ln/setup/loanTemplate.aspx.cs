...
{
    public partial class loanTemplate : corePage
    {
        core_dbEntities ent;
        coreLoansEntities le;
        public override string URL
        {
            get { return "~/ln/setup/loanTemplate.aspx"; }
        }
        ...
        protected void RadGrid1_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == Telerik.Web.UI.RadGrid.InitInsertCommandName)
            {
                ...
                newVals["templateName"] = string.Empty;
                newVals["templateBody"] = string.Empty; 
        ...
        protected void btnExcel_Click(object sender, System.EventArgs e)
        {
            ...
            this.RadGrid1.ExportSettings.FileName = "coreERP_loanTemplates";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Canceled = true; 
                var loanTemplateID = (int)e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["loanTemplateID"];
                var b = le.loanTemplates.FirstOrDefault(p=> p.loanTemplateID==loanTemplateID);
                b.templateName = newVals["templateName"].ToString();
                b.templateBody = newVals["templateBody"].ToString();
                le.SaveChanges();
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                e.Item.OwnerTableView.ExtractValuesFromItem(newVals, (GridEditableItem)e.Item);
                e.Canceled = true;
                coreLogic.loanTemplate b = new coreLogic.loanTemplate();
                b.templateName = newVals["templateName"].ToString();
                b.templateBody = newVals["templateBody"].ToString();
                
                le.loanTemplates.Add(b);
                le.SaveChanges();
