<%@ Page Title="" Language="C#" MasterPageFile="~/coreERP.Master" AutoEventWireup="true" CodeBehind="region.aspx.cs" Inherits="coreERP.ln.setup.region" %>
...
<MasterTableView autogeneratecolumns="False" EditMode="InPlace"
            datakeynames="regionID" datasourceid="EntityDataSource1" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
               CommandItemDisplay="Top" Width="960px">
    <Columns>
        <telerik:GridBoundColumn DataField="regionID" DataType="System.Int32" 
            DefaultInsertValue="" HeaderText="regionID" ReadOnly="True" 
            SortExpression="regionID" UniqueName="regionID" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="regionName" DefaultInsertValue="" 
            HeaderText="region Name" SortExpression="regionName" UniqueName="regionName" ItemStyle-Width="220px">
        </telerik:GridBoundColumn>  
        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn" 
          ...
          <telerik:GridButtonColumn CommandName="Delete" Text="Delete" UniqueName="DeleteColumn" 
            ...
            ConfirmText="Are you sure you want to delete the selected region?">
