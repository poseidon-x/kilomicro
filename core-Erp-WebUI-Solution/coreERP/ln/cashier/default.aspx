<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="coreERP.ln.cashier._default" %>
                   ...
                   <MasterTableView DataKeyNames="clientID">
                       ...
                       <DetailTables>
                           <telerik:GridTableView  ShowFooter="true" DataKeyNames="clientID">  
                                <Columns>            
                                   <telerik:GridHyperLinkColumn DataTextField="loanNo"  HeaderText="Disburse Loan" Target="_blank"
                                       DataNavigateUrlFields="loanID" DataNavigateUrlFormatString="/ln/cashier/disburse.aspx?id={0}"></telerik:GridHyperLinkColumn>
