<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="loanProjections.aspx.cs" Inherits="coreERP.ln.reports.loanProjections" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.3500.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    ::Loans Projections Report
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Client Loans Projection</h3>
    <div class="subForm">
        ...
        <div class="subFormColumnRight">
            ...
            <div class="subFormInput">
                <asp:RadioButton runat="server" CssClass="inputControl" ID="rbDetail" Checked="true" GroupName="Opt2" Text="All"   
                     AutoPostBack="true" OnCheckedChanged="rbDetail_CheckedChanged" CausesValidation="false" />
                <asp:RadioButton runat="server" CssClass="inputControl" ID="rbSummary" Checked="false" GroupName="Opt2" Text="Delinquent"
                     AutoPostBack="true" OnCheckedChanged="rbSummary_CheckedChanged" CausesValidation="false" />
                <asp:RadioButton runat="server" CssClass="inputControl" ID="rbCompleted" Checked="false" GroupName="Opt2" Text="Performing"   
