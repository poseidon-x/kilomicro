<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="multiPayment.aspx.cs" Inherits="coreERP.ln.reports.multiPayment" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.3500.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    ::Loans Repayment (Return of Funds)
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    ...
    <div class="subForm">
        <div class="subFormColumnLeft">
            ...
            <div class="subFormInput">
                <telerik:RadComboBox ID="cboClient" runat="server" AutoPostBack="true"
                    ...
                    LoadingMessage="Loading client data: type name or account number" OnSelectedIndexChanged="cboClient_SelectedIndexChanged">
                </telerik:RadComboBox>
            </div>
        </div>
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                <telerik:RadComboBox ID="cboRepayment" CssClass="inputControl" runat="server"
                    DropDownWidth="355px" EmptyMessage="Select a Repayment" HighlightTemplatedItems="true"
                    MarkFirstMatch="true" AutoCompleteSeparator="">
                </telerik:RadComboBox>
            </div>
        </div>
