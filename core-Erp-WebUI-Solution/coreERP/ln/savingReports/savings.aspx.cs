...
{
    public partial class savings : corePage
    {
        ReportDocument rpt;
                coreLoansEntities le = new coreLoansEntities();
        public override string URL
        {
            get { return "~/ln/savingReports/savings.aspx"; }
        }
        ...
        protected void btnRun_Click(object sender, EventArgs e)
        {
           ...
           // Session["loanOfficer"] = cboOfficer.SelectedValue;
            ...
            Session["staff"] = cboStaff.SelectedValue;
            var type = 2;
        ...
        //{
        //    int selectedStaff = -1;
        //    if (!String.IsNullOrEmpty(cboStaff.SelectedValue))
        //    {
        //        int.TryParse(cboStaff.SelectedValue, out selectedStaff);
        //    }
        //    //var staff = Session["staff"].ToString() == "" ? null : Session["staff"].ToString();
        //    if (type == 1)
        //    {
        //        rpt = new coreReports.sv.rptSaving2();
        //    }
        //    else
        //    {
        //        rpt = new coreReports.sv.rptSaving();
        //    }
        ...
        //        if (clientID == null )
        //        {
        //            var res = (new reportEntities().getSavingBalanceReport(endDate).Where(p => selectedStaff == -1 || p.staffID == selectedStaff).ToList());
        //            if (res.Count == 0)
        //            {
        ...
        //        {
        //            var res = (new reportEntities().getSavingBalanceReport(endDate).Where(p => p.clientID == clientID).Where(p => /*selectedStaff == null*/ selectedStaff == -1 || p.staffID == selectedStaff).ToList());
        //            if (res.Count == 0)
        //            {
        //                HtmlHelper.MessageBox("Report cannot be displaid because no data was found for the provided criteria", "coreERP©: No Data", IconType.deny);
        //                return;
