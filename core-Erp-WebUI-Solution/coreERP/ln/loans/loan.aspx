<%@ Page Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="loan.aspx.cs" Inherits="coreERP.ln.loans.loan" EnableEventValidation="false"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Loan Account Management</h3>
        <div class="subForm">
            <div class="subFormColumnLeft">
                ...
                <div class="subFormInput">
                    <telerik:RadTextBox WrapperCssClass="inputControl" ID="txtAccountNo" runat="server" CssClass="form-control"
                ...
                <div class="subFormLabel">
                    <telerik:RadButton ID="btnFind" runat="server" Text="Find Client" 
            ...
            <div class="subFormColumnMiddle">       
                ...
                <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtAmountRequested" runat="server" CssClass="form-control"
                ...
                <asp:Panel runat="server" ID="pnlCat5" Visible="true">
                    ...
                    <div class="subFormInput">
                        <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtTenure" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="2"  
                ...
                <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtRate" runat="server" CssClass="form-control"
            ...
            <div class="subFormColumnRight">  
               ...
               <div class="subFormInput">
                ...
                <asp:Panel runat="server" ID="trInsurance" Visible="false">
                    ...
                    <div class="subFormInput">
                        <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtInsurance" runat="server" CssClass="form-control" 
                ...
                <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ReadOnly="true" ID="txtAmountApproved" runat="server" CssClass="form-control"></telerik:RadNumericTextBox>
                </div>
                <div class="subFormLabel">
                        Amount Disbursed
                </div>
                ...
                <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ReadOnly="true" ID="txtBalance" runat="server" CssClass="form-control"></telerik:RadNumericTextBox>
                </div>
                <div class="subFormLabel">
                    Processing Fee
                </div>
                <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtProcFee" runat="server" CssClass="form-control" Value="0" NumberFormat-DecimalDigits="2"
                ...
                <div class="subFormInput">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtSecurityDeposit" runat="server" CssClass="form-control" Value="0" NumberFormat-DecimalDigits="2"
                    ToolTip=""></telerik:RadNumericTextBox>
                </div>
                <div class="subFormLabel">
                    Application Fee
                </div>
                <div class="subFormInput" id="ApplicationFeeDiv">
                    <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtApplicationFee" ReadOnly="true" runat="server" CssClass="form-control" Value="0" NumberFormat-DecimalDigits="2"
                    ToolTip=""></telerik:RadNumericTextBox>
                </div>
                <asp:Panel runat="server" ID="pnlFees" Visible="false">   
                    ...
                    <div class="subFormInput">
                        <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtGracePeriod" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0"></telerik:RadNumericTextBox>
                            &nbsp;Days
        ...
        <div class="subForm">
            <telerik:RadButton ID="btnSave" Text="Save Loan Application" runat="server" OnClick="btnSave_Click"
                ToolTip="Click to save the loan application and exit this screen"></telerik:RadButton>
            <telerik:RadButton ID="btnSave2" Text="Save To Continue Later" runat="server" OnClick="btnSave2_Click"
                ToolTip="Click to save the loan application and continue to stay on this screen"></telerik:RadButton>
            <telerik:RadButton ID="btnApprove" Text="Approve Loan Application" runat="server" OnClick="btnApprove_Click" Enabled="False"
                ToolTip="Click to approve this loan application"></telerik:RadButton>
        </div>        
    <telerik:RadTabStrip ID="tab1" MultiPageID="multi1" runat="server" SelectedIndex="3" Width="100%">
        <Tabs>
            ...
            <telerik:RadTab runat="server" Text="Loan Guarantors"
                 ToolTip="Click to edit/view the guarantor information for this loan">   
            </telerik:RadTab>
            <telerik:RadTab runat="server" Text="Loan Collaterals"
                 ToolTip="Click to edit/view the collateral information for this loan" Selected="True"> 
            </telerik:RadTab> 
    ...
    <telerik:RadMultiPage runat="server" ID="multi1" Width="100%" SelectedIndex="3">
        <telerik:RadPageView ID="RadPageView10" runat="server" Selected="true"> 
            ...
            <div class="subForm">
                <div class="subForm">
                    <telerik:RadButton ID="btnAddAllowance" runat="server" Text="Add Allowance" OnClick="btnAddAllowance_Click"
                                ToolTip="Click to add this allowance entry to the loan application. Click save when done"></telerik:RadButton>  
                </div>
            </div> 
        ...
        <telerik:RadPageView ID="RadPageView1" runat="server"> 
                ...
                <div class="subFormColumnLeft">
                    ...
                    <div class="subFormInput">
                        <telerik:RadTextBox WrapperCssClass="inputControl" ID="txtGSurname" runat="server" CssClass="inputControl"
                         ...
                         <asp:RequiredFieldValidator ID="rfvtxtGSurname" runat="server" ControlToValidate="txtGSurname" ErrorMessage="!" ForeColor="Red"
                       ToolTip="Please supply Surname"></asp:RequiredFieldValidator>
                    </div>
                    <div class="subFormLabel">
                        Other Names
                    </div>
                    <div class="subFormInput">
                        ...
                        <asp:RequiredFieldValidator ID="rfvtxtGOtherNames" runat="server" ControlToValidate="txtGOtherNames" ErrorMessage="!" ForeColor="Red"
                       ToolTip="Please supply Othernames"></asp:RequiredFieldValidator>
                    </div>
                    <div class="subFormLabel">
                        ID Number
                    </div>
                    <div class="subFormInput">
                       ...
                       ToolTip="Please supply IDType"></asp:RequiredFieldValidator>
                        ...
                        <asp:RequiredFieldValidator ID="rfvtxtIDNo" runat="server" ControlToValidate="txtIDNo" ErrorMessage="!" ForeColor="Red"
                       ToolTip="Please supply IDType"></asp:RequiredFieldValidator>
                    </div>
                    <div class="subFormLabel">
                        DOB
                    ...
                    <div class="subFormInput">
                        ...
                        <%--<asp:RequiredFieldValidator ID="rfvdtGDOB" runat="server" ControlToValidate="dtGDOB" ErrorMessage="!" ForeColor="Red"
                       ToolTip="Please supply IDType"></asp:RequiredFieldValidator>--%>
                    </div>
                </div>
                <div class="subFormColumnMiddle">
                    ...
                    <div class="subFormInput">
                       <telerik:RadTextBox WrapperCssClass="inputControl" InputType="Number" MaxLength="10" MinLength="10" ID="txtPhoneNo" runat="server" CssClass="inputControl"
                                ToolTip="Enter the phone number of the guarantor for this loan application"></telerik:RadTextBox>
                        <asp:RequiredFieldValidator ID="rfvtxtPhoneNo" runat="server" ControlToValidate="txtPhoneNo" ErrorMessage="!" ForeColor="Red"
                       ToolTip="Please supply Phone number"></asp:RequiredFieldValidator>
                    </div>
                    <div class="subFormLabel">
                        Guarantor Address
                    </div>
            ...
            <div class="subForm">
                <div class="subForm">
                    <telerik:RadButton ID="btnAddGuarantor" runat="server" Text="Add Guarantor" OnClick="btnAddGuarantor_Click"
                                ToolTip="Click to add this guarantor to the loan application. Click Save when done"></telerik:RadButton>
                    <telerik:RadButton ID="btnGuarantorAsApplicant" runat="server" Text="Guarantor is Applicant" OnClick="btnGuarantorAsApplicant_Click"
                            ToolTip="Click if the applicant is the guarantor of the loan application"></telerik:RadButton>
                </div>
            </div>  
        ...
        <telerik:RadPageView ID="RadPageView2" runat="server"> 
            ...
            <div class="subForm">
                <div class="subForm">
                   <telerik:RadButton ID="btnAddCollateral" runat="server" Text="Add Collateral" 
                       OnClick="btnAddCollateral_Click"
                                ToolTip="Click to add this collateral item to the loan application. CLick save when done"></telerik:RadButton>  
                </div>
            </div>   
        ...
        <telerik:RadPageView ID="RadPageView5" runat="server"> 
            ...
            <div class="subForm">
                <div class="subForm">
                    <telerik:RadButton ID="btnAddFinancial" runat="server" Text="Add Financials" OnClick="btnAddFinancial_Click"
                                ToolTip="Click to add this financials entry to the loan application. Click save when done"></telerik:RadButton>  
                </div>
            </div>   
        ...
        <telerik:RadPageView ID="RadPageView8" runat="server"> 
            ...
            <div class="subForm">
                <div class="subForm">
                    <telerik:RadButton ID="btnAddDcoument" runat="server" Text="Add Document" OnClick="btnAddDcoument_Click"
                                ToolTip="Click to add this document to the loan application. Click save when done"></telerik:RadButton>
                </div>
            </div>    
