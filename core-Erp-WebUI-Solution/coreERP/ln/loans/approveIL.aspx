<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="approveIL.aspx.cs" Inherits="coreERP.ln.loans.approveIL" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    ...
    <div class="subForm">
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                <telerik:RadDatePicker ID="dtApprDate" runat="server" CssClass="inputControl" DateInput-DateFormat="dd-MMM-yyyy"></telerik:RadDatePicker>
            </div>
        </div>
    ...
    <div class="subForm"> 
        <telerik:RadButton ID="btnSave" runat="server" Text="Approve Invoice Loans" OnClick="btnSave_Click"></telerik:RadButton> 
    </div>  
