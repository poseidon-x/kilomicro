<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="controllerOut.aspx.cs" 
    Inherits="coreERP.ln.loans.controllerOut" MaintainScrollPositionOnPostback="true" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width:200px">
                        <telerik:RadAsyncUpload runat="server" ID="upload1" InputSize="25"  Width="250px" AllowedFileExtensions="txt,csv,dat" Localization-Select="Select Controller File" MaxFileSize="100024000" UploadedFilesRendering="BelowFileInput"></telerik:RadAsyncUpload>
                    </td>
                </tr>
                <tr>
                    <td>Month (YYYYMM)</td>
                    <td>
                        <telerik:RadNumericTextBox WrapperCssClass="inputControl" runat="server" id="txtMonth" ></telerik:RadNumericTextBox>
                    </td>
                </tr>    
                <tr>
                    <td></td>
        ...
        <telerik:RadPageView ID="RadPageView2" runat="server"> 
            <h2>Please verify the details of the file below to continue</h2> 
             <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="EntityDataSource1" 
                 OnItemCommand="RadGrid1_OnItemCommand" OnItemDataBound="RadGrid1_OnItemDataBound"
             ...
             <telerik:RadGrid ID="RadGrid2" runat="server" DataSourceID="EntityDataSource2" OnItemCommand="RadGrid2_OnItemCommand"
                ...
                <MasterTableView autogeneratecolumns="False" EditMode="InPlace"
                    ...
                    <Columns>
                        ...
                        <telerik:GridCheckBoxColumn DataField="authorized" DefaultInsertValue="" 
                            HeaderText="Posted" SortExpression="authorized" UniqueName="authorized" ItemStyle-Width="120px">
