<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="viewProvision.aspx.cs" Inherits="coreERP.ln.loans.viewProvision" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    ::View Loan Provisions
</asp:Content>
        ...
        <ItemTemplate>
            <table width="1000px">
                <tr>
                    ...
                    <td style="width:100px">
                       <telerik:RadNumericTextBox WrapperCssClass="inputControl" ID="txtAmt" OnTextChanged="txtAmt_OnTextChanged" Width="100px" runat="server" Value='<%#  DataBinder.Eval(Container.DataItem, "provisionAmount") %>'></telerik:RadNumericTextBox>                        
                    </td> 
                    <td style="width:100px">
