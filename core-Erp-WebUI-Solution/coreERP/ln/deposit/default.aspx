<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="coreERP.ln.deposit._default" %>
                   ...
                   <MasterTableView DataKeyNames="clientID">
                       ...
                       <DetailTables>
                           <telerik:GridTableView  ShowFooter="true" DataKeyNames="client.clientID">  
                                <Columns>                             
                                   <telerik:GridHyperLinkColumn DataTextField="depositNo"  HeaderText="Deposit No."
                                       DataNavigateUrlFields="depositID" DataNavigateUrlFormatString="/ln/deposit/deposit.aspx?id={0}"></telerik:GridHyperLinkColumn>
