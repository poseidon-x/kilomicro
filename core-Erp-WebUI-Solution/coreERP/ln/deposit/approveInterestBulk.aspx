...
<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="true" CodeBehind="approveInterestBulk.aspx.cs" Inherits="coreERP.ln.deposit.approveInterestBulk" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    ::Bulk Approve Deposit Interest
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">
    <h3>Bulk Deposit Interest Approval</h3>
    <table>
        <tr>
            <td> 
            </td>
