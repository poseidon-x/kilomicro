<%@ Page Title="" Language="C#" MasterPageFile="~/ln/ln.master" AutoEventWireup="True" CodeBehind="with.aspx.cs" Inherits="coreERP.ln.deposit.with" %>
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="server">
    Withdrawal from Client Investment Account
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" runat="server">  
    <h3>Withdrawal from Client Investment Account</h3>  
    <div class="subForm">
        <div class="subFormColumnLeft">
            <div class="imageFrame">
                <telerik:RadBinaryImage runat="server" ID="RadBinaryImage1"
                                AutoAdjustImageControlSize="false" Width="216" Height="216"  />
            </div>
        ...
        <div class="subFormColumnMiddle">
            ...
            <div class="subFormInput">
                <telerik:RadNumericTextBox WrapperCssClass="inputControl" AutoPostBack="true" ID="txtAmount" OnTextChanged="txtAmount_OnTextChanged" runat="server" CssClass="form-control"></telerik:RadNumericTextBox>
            </div>
            <div class="subFormLabel">
                Withdrawal Date
            </div>
        ...
        <div class="subFormColumnRight">
            ...
            <div class="subFormInput">
                <telerik:RadComboBox Enabled="false" id="cboDepositType" runat="server" 
                        AutoPostBack="true" OnSelectedIndexChanged="cboDepositType_SelectedIndexChanged"
            ...
            <asp:Panel ID="panelWithdrwalCharge" runat="server" Visible="false"> 
                <div class="subFormLabel">
                   Withdrawal Charge
                </div>
                <div class="subFormInput">
                <telerik:RadNumericTextBox WrapperCssClass="inputControl"  ReadOnly="true" ID="txtWithdrawalCharge" runat="server" CssClass="form-control" NumberFormat-DecimalDigits="0" ></telerik:RadNumericTextBox>
            </div>
            </asp:Panel>
