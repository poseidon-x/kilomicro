...
select clientID, clientName,loanNo,sum(Payable) as Payable,sum(Paid) as Paid,
...
from
(
SELECT  l.clientID as clientID, concat(cl.Surname, ' ', cl.otherNames) AS clientName, l.loanNo,0 as 'Paid', 0 as 'WriteOff',
...
UNION ALL
SELECT   l.clientID as clientID,concat(cl.Surname, ' ', cl.otherNames) AS clientName, l.loanNo, amountPaid AS 'Paid',
...
UNION ALL
SELECT l.clientID as clientID, concat(cl.Surname, ' ', cl.otherNames) AS clientName, l.loanNo, 0 AS 'Paid',
...
group by clientID, clientName,loanNo,loanGroupId,loanGroupName,loanGroupNumber
GO
