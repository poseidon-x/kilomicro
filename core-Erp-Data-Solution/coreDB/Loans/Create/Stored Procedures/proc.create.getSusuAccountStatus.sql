...
alter procedure ln.getSusuAccountStatus
(
	@date datetime,
	@clientId int = null
)
...
begin
	SELECT sa.susuAccountID, c.clientID, ISNULL(CASE WHEN (c.clientTypeID = 3 OR
		...
		ISNULL(sg.susuGradeName, '') AS susuGradeName, 
		ISNULL(sp.susuPositionNo, 0) AS susuPositionNo, 
		ISNULL(sp.susuPositionName, '') AS susuPositionName, 
