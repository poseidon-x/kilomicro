...
namespace coreReports.dp {
    ...
    public class rptDeposit2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "coreReports.dp.rptDeposit2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptDeposit2 : Component, ICachedReport {
        
        public CachedrptDeposit2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptDeposit2 rpt = new rptDeposit2();
            rpt.Site = this.Site;
            return rpt;
        }
