...
namespace coreReports.ln.bog {
    ...
    public class rptMF7A2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "coreReports.ln.bog.rptMF7A2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMF7A2 : Component, ICachedReport {
        
        public CachedrptMF7A2() {
        }
