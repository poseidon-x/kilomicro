...
namespace coreReports.ln.bog {
    ...
    public class rptMF7A : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "coreReports.ln.bog.rptMF7A.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMF7A : Component, ICachedReport {
        
        public CachedrptMF7A() {
        }
