...
namespace coreReports.ln.bog {
    ...
    public class rptMF7B : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "coreReports.ln.bog.rptMF7B.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMF7B : Component, ICachedReport {
        
        public CachedrptMF7B() {
        }
