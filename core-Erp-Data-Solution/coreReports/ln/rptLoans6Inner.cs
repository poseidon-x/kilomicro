...
namespace coreReports.ln {
    ...
    public class rptLoans6Inner : ReportClass {
        
        public rptLoans6Inner() {
        }
        
        public override string ResourceName {
            get {
                return "rptLoans6Inner.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "coreReports.ln.rptLoans6Inner.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptLoans6Inner : Component, ICachedReport {
        
        public CachedrptLoans6Inner() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptLoans6Inner rpt = new rptLoans6Inner();
            rpt.Site = this.Site;
            return rpt;
        }
