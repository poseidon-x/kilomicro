...
namespace coreReports.ln {
    ...
    public class rptLoans3Sum : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "coreReports.ln.rptLoans3Sum.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptLoans3Sum : Component, ICachedReport {
        
        public CachedrptLoans3Sum() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptLoans3Sum rpt = new rptLoans3Sum();
            rpt.Site = this.Site;
            return rpt;
        }
