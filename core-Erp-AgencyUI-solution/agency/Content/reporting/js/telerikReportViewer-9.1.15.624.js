/*
* TelerikReporting v9.1.15.624 (http://www.telerik.com/products/reporting.aspx)
...
(function(trv, $, window, document, undefined) {
    ...
    function ParametersArea(placeholder, options, otherOptions) {
        ...
        function setParametersAreaInitialState(parametersAreaState) {
            controller.setParametersAreaVisible(parametersAreaState);
        }
        ...
        function loadParameters(parameterValues) {
            ...
            $.when(controller.loadParameters(parameterValues)).done(function(parameters) {
                ...
                var parametersAreaState = {};
                if (options.parametersAreaVisible !== undefined) {
                    setParametersAreaInitialState({
                        visible: options.parametersAreaVisible
                    });
                    options.parametersAreaVisible = undefined;
                }
                tryRefreshReport();
                endLoad();
            }).fail(function(error) {
...
(function(trv, $, window, document, undefined) {
    ...
    function ReportViewerSettings(id, storage, defaultSettings) {
        ...
        $this = $.extend($this, {
            ...
            documentMapEnabled: function() {
                return stateItem("documentMapEnabled", arguments);
            },
            parametersAreaVisible: function() {
                return stateItem("parametersAreaVisible", arguments);
            },
            parametersAreaEnabled: function() {
                return stateItem("parametersAreaEnabled", arguments);
            },
            history: function() {
    ...
    function ReportViewer(dom, options) {
        ...
        function start() {
            ...
            if (options.persistSession) {
                controller.viewMode(settings.viewMode());
                controller.printMode(settings.printMode());
                controller.reportLoadComplete(function(event, args) {
                    if (options.documentMapVisible !== undefined) {
                        setDocumentMapInitialState({
                            visible: options.documentMapVisible
                        });
                        options.documentMapVisible = undefined;
                    }
                });
                controller.scale({
                ...
                controller.setDocumentMapVisible({
                    documentMapVisible: settings.documentMapVisible(),
                    documentAreaEnabled: settings.documentMapEnabled()
                });
                controller.setParametersAreaVisible({
                    parametersAreaVisible: settings.parametersAreaVisible(),
                    parametersAreaEnabled: settings.parametersAreaEnabled()
                });
        ...
        function setDocumentMapInitialState(documentMapState) {
            controller.setDocumentMapVisible(documentMapState);
        }
...
/* DO NOT MODIFY OR DELETE THIS LINE! UPGRADE WIZARD CHECKSUM BFEFF4862642F78AA4D1401AF640E3A7 */