...
var savingAdditionalApiUrl = agencyAPI_URL_Root + "/Saving";
...
var savingAjax = $.ajax({
    url: savingAdditionalApiUrl + '/GetSavingAdditional/' + depositId,
    type: 'Get',
...
function renderControls() {
	...
	$("#depositAmount").width("90%").kendoNumericTextBox();
	...
	$("#interestRate").width("90%").kendoNumericTextBox();
...
function retrieveValues(){
	...
	savingAdditional.naration = $("#narration").data("kendoMaskedTextBox").value();
    savingAdditional.savingID = savingAdditional.saving.savingID;
}
...
function saveToServer() {	
    ...
    $.ajax({
        ...
        dismissLoadingDialog();
        successDialog('Deposit Successfully received', 'SUCCESS', function () { window.location = '/Agent/Dashboard'; });        
    }).error(function (xhr, data, error) {
		dismissLoadingDialog();
		warningDialog(xhr.responseJSON.ExceptionMessage,'ERROR'); 
	});	
